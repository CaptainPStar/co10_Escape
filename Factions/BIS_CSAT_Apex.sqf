...
_returnNames append ["AmmoDepotBasicWeapons"];
_returnValues append [
...
_returnNames append ["AmmoDepotSpecialWeapons"];
_returnValues append [
...
_returnNames append ["AmmoDepotLaunchers"];
_returnValues append [
...
_returnNames append ["AmmoDepotExplosives"];
_returnValues append [
...
_returnNames append ["AmmoDepotGrenades"];
_returnValues append [
...
// Backpacks
_returnNames append ["AmmoDepotBackpacks"];
_returnValues append [
	["backpack", "O_UAV_01_backpack_F"]
];
// Items
_returnNames append ["AmmoDepotItems"];
_returnValues append [
...
// Nightvision Goggles
_returnNames append ["AmmoDepotNVGs"];
_returnValues append [
	["item", "O_NVGoggles_ghex_F", 10, 1, 3]
];
// Suppressors
_returnNames append ["AmmoDepotSuppressors"];
_returnValues append [
