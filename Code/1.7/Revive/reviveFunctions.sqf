...
AT_FNC_Revive_Actions = {
	...
	{
		player addAction ["<t size=""1.25"" color=""#C90000"">" + "Revive (with FAK)" + "</t>", "_this spawn AT_FNC_Revive_HandleRevive;", [cursorTarget,true], 19, true, true, "", "call AT_FNC_Revive_Check_Revive_FAK"];
		player addAction ["<t size=""1.25"" color=""#C90000"">" + "Revive" + "</t>", "_this spawn AT_FNC_Revive_HandleRevive;", [cursorTarget], 18, true, true, "", "call AT_FNC_Revive_Check_Revive"];
		player addAction ["<t size=""1.25"" color=""#FFA500"">" + "Drag" + "</t>", "_this spawn AT_FNC_Revive_Drag;", [cursorTarget], 17, false, true, "", "call AT_FNC_Revive_Check_Dragging"];
		player addAction ["<t size=""1.25"" color=""#FFA500"">" + "Put in injured" + "</t>", "_this spawn AT_FNC_Revive_PutInVehicle;", [], 17, false, true, "", "call AT_FNC_Revive_Check_Putin"];
		player addAction ["<t size=""1.25"" color=""#FFA500"">" + "Pull out injured" + "</t>", "_this spawn AT_FNC_Revive_PullPutVehicle;", [], 17, false, true, "", "call AT_FNC_Revive_Check_Pullout"];
	};
...
{
	private["_attendant","_params"];
	_params = _this select 3;
	_target = cursortarget;
	_fakUsed = _params param [1,false];
...
AT_FNC_Revive_InstantRevive = 
{
	...
	_target setCaptive false;
	[[_target,false],"at_fnc_revive_hide",true] call BIS_fnc_MP;
	_target setVariable ["AT_Revive_isUnconscious", false, true];
	_target setVariable ["AT_Revive_isDragged", objNull, true];
...
AT_FNC_Revive_Drag =
{
	...
	if(call AT_FNC_Revive_Check_Dragging) then {
		...
		_id = player addAction ["<t color=""#FFA500"">" + "Release" + "</t>", AT_FNC_Revive_Release, [], 10, true, true, "", "true"];
