if (alive player) then 
{
	...
	player addAction ["<t size=""1.25"" color=""#FFA500"">" + "Drag" + "</t>", "_this spawn ATR_FNC_Drag;", [cursorTarget], 17, false, true, "", "call ATR_FNC_Check_Dragging"];
	...
	player addAction ["<t size=""1.25"" color=""#FFA500"">" + "Pull out injured" + "</t>", "_this spawn ATR_FNC_PullPutVehicle;", [], 17, false, true, "", "call ATR_FNC_Check_Pullout"];
};