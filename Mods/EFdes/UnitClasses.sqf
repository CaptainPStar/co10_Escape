...
A3E_VAR_Side_Opfor = west;		//Expeditionary Forces: MJTF Desert
A3E_VAR_Side_Ind = resistance;	//FIA
...
switch (_enemyFrequency) do {
    case 1: {//Few (1-3)
		...
		if(isClass(configFile >> "CfgPatches" >> "rf_vehicles")) then {
			a3e_arr_Escape_MilitaryTraffic_EnemyVehicleClasses pushback "EF_B_Pickup_MJTF_Des";
			a3e_arr_Escape_MilitaryTraffic_EnemyVehicleClasses pushback "EF_B_Pickup_Comms_MJTF_Des";
			a3e_arr_Escape_MilitaryTraffic_EnemyVehicleClasses pushback "EF_B_Pickup_mmg_MJTF_Des";
			a3e_arr_Escape_MilitaryTraffic_EnemyVehicleClasses pushback "EF_B_Pickup_mmg_MJTF_Des";
		};
		...
		if(isClass(configFile >> "CfgPatches" >> "rf_vehicles")) then {
			a3e_arr_Escape_MilitaryTraffic_EnemyVehicleClasses_IND pushback "I_G_Pickup_mrl_rf";
			a3e_arr_Escape_MilitaryTraffic_EnemyVehicleClasses_IND pushback "I_G_Pickup_rf";
			a3e_arr_Escape_MilitaryTraffic_EnemyVehicleClasses_IND pushback "I_G_Pickup_rf";
			a3e_arr_Escape_MilitaryTraffic_EnemyVehicleClasses_IND pushback "I_G_Pickup_hmg_rf";
			a3e_arr_Escape_MilitaryTraffic_EnemyVehicleClasses_IND pushback "I_G_Pickup_hmg_rf";
			a3e_arr_Escape_MilitaryTraffic_EnemyVehicleClasses_IND pushback "I_G_Pickup_fuel_rf";
			a3e_arr_Escape_MilitaryTraffic_EnemyVehicleClasses_IND pushback "I_G_Pickup_repair_rf";
		};
    };
    case 2: {//Some (4-6)
	    a3e_arr_Escape_MilitaryTraffic_EnemyVehicleClasses = [
...
a3e_arr_Escape_InfantryTypes_Ind = [
	...
	if(A3E_Param_UseDLCTanks==1) then {
		a3e_arr_Escape_InfantryTypes_Ind pushback "I_G_Soldier_LAT2_F";
	};
	if(A3E_Param_UseDLCMarksmen==1) then {
		a3e_arr_Escape_InfantryTypes_Ind pushback "I_G_Sharpshooter_F";
	};
	if(isClass(configFile >> "CfgPatches" >> "rf_vehicles")) then {
			a3e_arr_Escape_InfantryTypes_Ind pushback "I_G_support_CMort_RF";
			a3e_arr_Escape_InfantryTypes_Ind pushback "I_G_support_CMort_RF";
			a3e_arr_Escape_InfantryTypes_Ind pushback "I_G_Scout_RF";
			a3e_arr_Escape_InfantryTypes_Ind pushback "I_G_Scout_RF";
	};
...
a3e_arr_recon_I_InfantryTypes = [
	...
	if(isClass(configFile >> "CfgPatches" >> "rf_vehicles")) then {
			a3e_arr_recon_I_InfantryTypes pushback "I_G_support_CMort_RF";
			a3e_arr_recon_I_InfantryTypes pushback "I_G_support_CMort_RF";
			a3e_arr_recon_I_InfantryTypes pushback "I_G_Scout_RF";
			a3e_arr_recon_I_InfantryTypes pushback "I_G_Scout_RF";
	};
...
a3e_arr_Escape_RoadBlock_MannedVehicleTypes_Ind = [
	...
	,"I_G_Offroad_01_AT_F"];
	if(isClass(configFile >> "CfgPatches" >> "rf_vehicles")) then {
			a3e_arr_Escape_RoadBlock_MannedVehicleTypes_Ind pushback "I_G_Pickup_hmg_rf";
	};
...
a3e_arr_Escape_ReinforcementTruck_vehicleClasses_Ind = [
	...
	,"I_G_Offroad_01_F"];
	if(A3E_Param_UseDLCLaws==1) then {
	a3e_arr_Escape_ReinforcementTruck_vehicleClasses_Ind pushback "I_G_Van_02_vehicle_F";
	a3e_arr_Escape_ReinforcementTruck_vehicleClasses_Ind pushback "I_G_Van_02_transport_F";
	};
	if(isClass(configFile >> "CfgPatches" >> "rf_vehicles")) then {
			a3e_arr_Escape_ReinforcementTruck_vehicleClasses_Ind pushback "I_G_Pickup_rf";
	};
...
a3e_arr_AmmoDepotSpecialWeapons pushback ["ef_arifle_mxar_black", 20, 2, 4, ["EF_100Rnd_65x39_caseless_coy_mag"], 4];
...
a3e_arr_AmmoDepotItems pushback ["muzzle_snds_acp", 25, 1, 3];
...
a3e_arr_AmmoDepotItems pushback ["ef_snds_mxar_sand", 1, 1, 3];
a3e_arr_AmmoDepotItems pushback ["ef_snds_mxar_khk", 1, 1, 3];
...
a3e_arr_AmmoDepotItems pushback ["ef_optic_mbs", 10, 1, 2];
a3e_arr_AmmoDepotItems pushback ["ef_optic_mbs_remote", 10, 1, 2];
a3e_arr_AmmoDepotItems pushback ["ef_optic_mbs_coy", 30, 1, 2];
a3e_arr_AmmoDepotItems pushback ["ef_optic_mbs_remote_coy", 10, 1, 2];
a3e_arr_AmmoDepotItems pushback ["ef_optic_mbs_sand", 1, 1, 2];
a3e_arr_AmmoDepotItems pushback ["ef_optic_mbs_remote_sand", 1, 1, 2];
...
a3e_arr_AmmoDepotItems pushback ["ef_optic_microsight_sand", 1, 1, 2];
...
a3e_arr_AmmoDepotItems pushback ["ef_optic_microsight_pistol_sand", 1, 1, 2];
...
a3e_additional_weapon_box_2 = "Box_FIA_Wps_F";
...
if(isClass(configFile >> "CfgPatches" >> "rf_vehicles")) then {
			a3e_arr_CrashSiteWeapons pushback ["arifle_ash12_desert_RF", 10, 2, 4, ["20Rnd_127x55_Mag_desert_RF"], 12];
			a3e_arr_CrashSiteWeapons pushback ["arifle_ash12_GL_desert_RF", 10, 2, 4, ["20Rnd_127x55_Mag_desert_RF","1Rnd_HE_Grenade_shell"], 12];
			a3e_arr_CrashSiteWeapons pushback ["arifle_ash12_LR_desert_RF", 10, 2, 4, ["20Rnd_127x55_Mag_desert_RF"], 12];
			a3e_arr_CrashSiteWeapons pushback ["srifle_DMR_01_tan_RF", 10, 2, 4, ["10Rnd_762x54_Mag"], 12];
		};
...
if(isClass(configFile >> "CfgPatches" >> "rf_vehicles")) then {
			a3e_arr_CrashSiteItems pushback ["suppressor_127x55_small_desert_RF", 10, 1, 3];
			a3e_arr_CrashSiteItems pushback ["optic_ACO_grn_desert_RF", 10, 1, 3];
			a3e_arr_CrashSiteItems pushback ["suppressor_127x55_big_desert_RF", 10, 1, 3];
			a3e_arr_CrashSiteItems pushback ["optic_ACO_desert_RF", 10, 1, 3];
			a3e_arr_CrashSiteItems pushback ["optic_VRCO_tan_RF", 10, 1, 3];
			a3e_arr_CrashSiteItems pushback ["H_HelmetHeavy_VisorUp_Hex_RF", 10, 1, 3];
		};