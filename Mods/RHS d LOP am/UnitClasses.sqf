...
a3e_arr_Escape_StartPositionGuardTypes = ["LOP_AM_Soldier", "LOP_AM_Soldier_GL", "LOP_AM_Soldier", "LOP_AM_Soldier_AR"];
...
switch (_enemyFrequency) do {
    case 1: {
        ...
        a3e_arr_Escape_MilitaryTraffic_EnemyVehicleClasses_IND = ["LOP_AM_GAZ66","LOP_AM_GAZ66o","LOP_AM_Landrover","LOP_AM_Landrover_M2","LOP_AM_Technical","LOP_AM_Technical_M2"];
    };
    case 2: {
...
a3e_arr_Escape_InfantryTypes_Ind = ["LOP_AM_Soldier_TL","LOP_AM_Soldier_SL","LOP_AM_Soldier_Engineer","LOP_AM_Soldier_Medic","LOP_AM_Soldier_AR","LOP_AM_Soldier_AT","LOP_AM_Soldier_Marksman","LOP_AM_Soldier","LOP_AM_Soldier_GL"];
...
a3e_arr_recon_I_InfantryTypes = ["LOP_AM_Soldier_TL","LOP_AM_Soldier_SL","LOP_AM_Soldier_Engineer","LOP_AM_Soldier_Medic","LOP_AM_Soldier_AR","LOP_AM_Soldier_AT","LOP_AM_Soldier_Marksman","LOP_AM_Soldier","LOP_AM_Soldier_GL"];

// Random array. A roadblock has a manned vehicle. This array contains possible manned vehicles (can be of any kind, like cars, armored and statics).
a3e_arr_Escape_RoadBlock_MannedVehicleTypes = ["rhs_btr60_msv", "RHS_NSV_TriPod_VDV", "O_static_AT_F"];
a3e_arr_Escape_RoadBlock_MannedVehicleTypes_Ind = ["LOP_AM_Landrover", "LOP_AM_Landrover_M2", "LOP_AM_Technical_M2", "LOP_AM_NSV_TriPod", "I_static_AT_F"];
...
a3e_arr_Escape_ReinforcementTruck_vehicleClasses_Ind = ["LOP_AM_GAZ66o"];
