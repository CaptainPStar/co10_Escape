...
a3e_arr_AmmoDepotLaunchers pushback ["vn_m127", 20, 1, 2, ["vn_m127_mag", "vn_m128_mag", "vn_m129_mag"], 2];
...
a3e_arr_CrashSiteWeapons pushback ["vn_m14", 75, 2, 4, ["vn_m14_mag"], 12];
