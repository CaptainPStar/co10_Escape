...
a3e_arr_Escape_ReinforcementTruck_vehicleClassesMaxCargo = [7, 7, 8, 9, 8, 8, 7, 8];
...
a3e_arr_Escape_MotorizedSearchGroup_vehicleClassesMaxCargo = [7, 7, 7, 4, 4, 8, 8, 9, 8, 8, 7, 7, 9, 12];
