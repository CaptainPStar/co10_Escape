...
drn_arr_Escape_StartPositionGuardTypes = ["CAF_AG_AFR_P_AK74", "CAF_AG_AFR_P_GL", "at_CAF_AG_AFR_P_AKS74", "at_CAF_AG_AFR_P_AK74_dirty"];
...
switch (_enemyFrequency) do {
    case 1: {
        ...
        drn_arr_Escape_MilitaryTraffic_EnemyVehicleClasses_IND = ["CAF_AG_afr_p_Offroad", "CAF_AG_afr_p_Offroad_armed_01", "CAF_AG_afr_p_Offroad_armed_01", "CAF_AG_afr_p_van_01"];
    };
    case 2: {
...
drn_arr_Escape_RoadBlock_MannedVehicleTypes_Ind = ["CAF_AG_afr_p_Offroad", "CAF_AG_afr_p_Offroad_armed_01", "CAF_AG_afr_p_Offroad_armed_01", "RHS_NSV_TriPod_VDV", "I_static_AT_F"];
...
drn_arr_Escape_ReinforcementTruck_vehicleClasses_Ind = ["CAF_AG_afr_p_van_01"];
...
a3n_arr_CSAT_Primary_Weapons set [0, ["rhs_weap_ak74m_camo", ["rhs_30Rnd_545x39_AK", "rhs_30Rnd_545x39_AK_green"], ["rhs_acc_1p29", "rhs_acc_ekp1"]]];
a3n_arr_CSAT_Primary_Weapons set [1, ["rhs_weap_ak74m_2mag_camo", ["rhs_30Rnd_545x39_AK", "rhs_30Rnd_545x39_AK_green"], ["rhs_acc_1p29", "rhs_acc_ekp1"]]];
