...
a3e_arr_Escape_StartPositionGuardTypes = ["LOP_UA_Infantry_Rifleman", "LOP_UA_Infantry_GL", "LOP_UA_Infantry_AR", "LOP_UA_Infantry_Rifleman"];
...
switch (_enemyFrequency) do {
    case 1: {
        ...
        a3e_arr_Escape_MilitaryTraffic_EnemyVehicleClasses_IND = ["LOP_UA_UAZ", "LOP_UA_Ural_open", "LOP_UA_Ural_fuel", "LOP_UA_Ural", "LOP_UA_BM21", "LOP_UA_BMP1", "LOP_UA_BMP2", "LOP_UA_ZSU234", "LOP_UA_T72BA", "LOP_UA_T72BB"];
    };
    case 2: {
...
a3e_arr_Escape_InfantryTypes_Ind = ["LOP_UA_Infantry_TL","LOP_UA_Infantry_SL","LOP_UA_Infantry_Corpsman","LOP_UA_Officer","LOP_UA_Infantry_MG","LOP_UA_Infantry_MG_Asst","LOP_UA_Infantry_AT","LOP_UA_Infantry_AT_Asst","LOP_UA_Infantry_Marksman","LOP_UA_Infantry_Engineer","LOP_UA_Infantry_Rifleman","LOP_UA_Infantry_GL"];
...
a3e_arr_Escape_RoadBlock_MannedVehicleTypes = ["rhs_btr60_msv", "RHS_NSV_TriPod_VDV", "O_static_AT_F", "LOP_UA_NSV_TriPod"];
a3e_arr_Escape_RoadBlock_MannedVehicleTypes_Ind = ["LOP_UA_UAZ", "LOP_UA_UAZ", "LOP_UA_NSV_TriPod", "I_static_AT_F"];
...
a3e_arr_Escape_ReinforcementTruck_vehicleClasses_Ind = ["LOP_UA_Ural_open","LOP_UA_Ural"];
...
a3e_arr_ComCenParkedVehicles = ["rhs_uaz_MSV_01","rhs_uaz_open_MSV_01","rhs_gaz66_msv","rhs_gaz66o_msv","rhs_gaz66_r142_msv","rhs_gaz66_ap2_msv","rhs_gaz66_repair_msv","rhs_ural_MSV_01","rhs_ural_fuel_MSV_01","rhs_ural_open_MSV_01","rhs_tigr_ffv_3camo_msv","rhs_tigr_ffv_msv", "LOP_UA_UAZ", "LOP_UA_Ural_open", "LOP_UA_Ural_fuel", "LOP_UA_Ural"];
...
a3e_arr_I_transport_heli = ["LOP_UA_Mi8MT_Cargo","LOP_UA_Mi8MTV3_UPK23"];
a3e_arr_I_pilots = ["LOP_UA_Infantry_Pilot"];
