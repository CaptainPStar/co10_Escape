...
a3e_arr_Escape_StartPositionGuardTypes = ["LOP_UA_Soldier", "LOP_UA_Soldier_GL", "LOP_UA_Soldier_AR", "LOP_UA_Soldier"];
...
switch (_enemyFrequency) do {
    case 1: {
        ...
        a3e_arr_Escape_MilitaryTraffic_EnemyVehicleClasses_IND = ["LOP_UA_UAZ", "LOP_UA_Ural_open", "LOP_UA_Ural_fuel", "LOP_UA_Ural", "LOP_UA_BM21", "LOP_UA_BTR60", "LOP_UA_BTR70", "LOP_UA_BMP1", "LOP_UA_BMP1D", "LOP_UA_BMP1K", "LOP_UA_BMP1P", "LOP_UA_BMP2", "LOP_UA_ZSU234", "LOP_UA_T72BA", "LOP_UA_T72BB"];
    };
    case 2: {
...
a3e_arr_Escape_InfantryTypes_Ind = ["LOP_UA_Soldier_TL","LOP_UA_Soldier_SL","LOP_UA_Soldier_Medic","LOP_UA_Officer","LOP_UA_Soldier_AR","LOP_UA_Soldier_A_AR","LOP_UA_Soldier_AT","LOP_UA_Soldier_A_AT","LOP_UA_Soldier_Marksman","LOP_UA_Soldier_Engineer","LOP_UA_Soldier","LOP_UA_Soldier_GL"];
...
a3e_arr_Escape_RoadBlock_MannedVehicleTypes_Ind = ["LOP_UA_UAZ", "LOP_UA_UAZ", "LOP_UA_BTR60", "LOP_UA_NSV_TriPod", "I_static_AT_F"];
...
a3e_arr_I_transport_heli = ["LOP_UA_Mi8","LOP_UA_Mi8MTW"];
a3e_arr_I_pilots = ["LOP_UA_Soldier_Pilot"];
