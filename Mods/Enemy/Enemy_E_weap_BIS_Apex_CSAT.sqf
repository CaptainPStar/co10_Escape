...
a3e_arr_AmmoDepotItems pushback ["muzzle_snds_58_blk_F", 10, 1, 3];//5.8, CSAT CTAR
a3e_arr_AmmoDepotItems pushback ["muzzle_snds_58_wdm_F", 10, 1, 3];//5.8, CSAT CTAR
a3e_arr_AmmoDepotItems pushback ["muzzle_snds_65_TI_blk_F", 10, 1, 3];//6.5, DMR_07 and ARX
a3e_arr_AmmoDepotItems pushback ["muzzle_snds_65_TI_hex_F", 10, 1, 3];//6.5, DMR_07 and ARX
a3e_arr_AmmoDepotItems pushback ["muzzle_snds_65_TI_ghex_F", 10, 1, 3];//6.5, DMR_07 and ARX
...
a3e_arr_Scopes pushback "optic_ACO_grn"; //CSAT, AAF, FIA
	a3e_arr_Scopes pushback "optic_Arco_ghex_F";//CSAT
...
a3e_arr_Scopes_Sniper pushback "optic_SOS";
	...
	a3e_arr_Scopes_Sniper pushback "optic_LRPS_ghex_F";
