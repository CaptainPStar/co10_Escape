...
a3e_arr_AmmoDepotBasicWeapons append [
	...
	,["SMG_02_F", 50, 4, 8, ["30Rnd_9x21_Mag"], 6]//Sting, CSAT
	,["arifle_Katiba_F", 100, 2, 4, ["30Rnd_65x39_caseless_green"], 6]
	,["arifle_Katiba_C_F", 50, 2, 4, ["30Rnd_65x39_caseless_green", "30Rnd_65x39_caseless_green_mag_Tracer"], 6]
	,["arifle_Katiba_GL_F", 75, 2, 4, ["30Rnd_65x39_caseless_green", "1Rnd_HE_Grenade_shell", "1Rnd_Smoke_Grenade_shell", "UGL_FlareWhite_F"], 4]
	,["hgun_Pistol_heavy_02_F", 10, 4, 8, ["6Rnd_45ACP_Cylinder"], 6]//Zubr, CSAT
	];

// Weapons and ammo in the special weapons box
// CSAT weapons
a3e_arr_AmmoDepotSpecialWeapons append [
	["srifle_DMR_01_F", 10, 2, 4, ["10Rnd_762x54_Mag"], 9]//Rahim, CSAT
	,["srifle_GM6_F", 10, 2, 4, ["5Rnd_127x108_Mag"], 9]//Lynx, CSAT
	,["LMG_Zafir_F", 50, 2, 4, ["150Rnd_762x54_Box", "150Rnd_762x54_Box_Tracer"], 6]//CSAT
	,["MMG_01_hex_F", 10, 2, 4, ["150Rnd_93x64_Mag"], 6]//Navid, CSAT
	,["srifle_DMR_06_olive_F", 10, 2, 4, ["20Rnd_762x51_Mag"], 10]//Mk14, FIA
	,["srifle_DMR_05_blk_F", 10, 2, 4, ["10Rnd_93x64_DMR_05_Mag"], 12]//Cyrus, CSAT
	,["srifle_DMR_04_F", 10, 2, 4, ["10Rnd_127x54_Mag"], 12]//ASP-1 Kir, CSAT
	];

// non-CAST weapons
//a3e_arr_AmmoDepotSpecialWeapons pushback ["srifle_LRR_F", 100, 2, 4, ["7Rnd_408_Mag"], 9];
a3e_arr_AmmoDepotSpecialWeapons append [
	["LMG_Mk200_F", 20, 2, 4, ["200Rnd_65x39_cased_Box", "200Rnd_65x39_cased_Box_Tracer"], 6]//AAF
	];
...
a3e_arr_AmmoDepotLaunchers append [
	["launch_RPG32_F", 50, 3, 5, ["RPG32_F", "RPG32_HE_F"], 6]
	,["launch_O_Titan_F", 50, 1, 1, ["Titan_AA"], 3]
	,["launch_O_Titan_short_F", 50, 1, 1, ["Titan_AP", "Titan_AT"], 3]
	];
...
a3e_arr_CivilianCarWeapons append [
	["hgun_Rook40_snds_F", "30Rnd_9x21_Mag", 9]
	,["arifle_Katiba_C_F", "30Rnd_65x39_caseless_green", 5]
	,["SMG_02_ACO_F", "30Rnd_9x21_Mag", 12]//Sting, CSAT
	,["launch_RPG32_F", "RPG32_F", 2]
	];
