...
a3e_arr_Escape_StartPositionGuardTypes = ["CAF_AG_ME_T_AK74", "CAF_AG_ME_T_GL", "CAF_AG_ME_T_AK47", "CAF_AG_ME_T_RPK74"];
...
switch (_enemyFrequency) do {
    case 1: {
        ...
        a3e_arr_Escape_MilitaryTraffic_EnemyVehicleClasses_IND = ["CAF_AG_ME_T_Offroad", "CAF_AG_ME_T_Offroad_armed_01", "CAF_AG_ME_T_Offroad_armed_01", "CAF_AG_ME_T_van_01"];
    };
    case 2: {
...
a3e_arr_Escape_InfantryTypes_Ind = ["CAF_AG_ME_T_AK47","CAF_AG_ME_T_AK74","CAF_AG_ME_T_RPK74","CAF_AG_ME_T_PKM","CAF_AG_ME_T_RPG","CAF_AG_ME_T_GL"];
...
a3e_arr_Escape_RoadBlock_MannedVehicleTypes_Ind = ["CAF_AG_ME_T_Offroad", "CAF_AG_ME_T_Offroad_armed_01", "CAF_AG_ME_T_Offroad_armed_01", "I_HMG_01_high_f", "I_static_AT_F"];
...
a3e_arr_Escape_ReinforcementTruck_vehicleClasses_Ind = ["CAF_AG_ME_T_van_01"];
...
a3e_arr_ComCenParkedVehicles = ["rhs_uaz_MSV_01","rhs_uaz_open_MSV_01","rhs_gaz66_msv","rhs_gaz66o_msv","rhs_gaz66_r142_msv","rhs_gaz66_ap2_msv","rhs_gaz66_repair_msv","rhs_ural_MSV_01","rhs_ural_fuel_MSV_01","rhs_ural_open_MSV_01","rhs_tigr_ffv_3camo_msv","rhs_tigr_ffv_msv", "CAF_AG_ME_T_Offroad", "CAF_AG_ME_T_Offroad_armed_01", "CAF_AG_ME_T_Offroad_armed_01", "CAF_AG_ME_T_van_01"];
