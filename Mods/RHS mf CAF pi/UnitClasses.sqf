...
switch (_enemyFrequency) do {
    case 1: {
        ...
        a3e_arr_Escape_MilitaryTraffic_EnemyVehicleClasses_IND = ["CAF_AG_afr_p_Offroad", "CAF_AG_afr_p_Offroad_armed_01", "CAF_AG_afr_p_Offroad_armed_01", "CAF_AG_afr_p_van_01"];
    };
    case 2: {
...
a3e_arr_Escape_InfantryTypes_Ind = ["CAF_AG_AFR_P_AK47","CAF_AG_AFR_P_AK74","CAF_AG_AFR_P_RPK74","CAF_AG_AFR_P_PKM","CAF_AG_AFR_P_RPG","CAF_AG_AFR_P_GL"];
