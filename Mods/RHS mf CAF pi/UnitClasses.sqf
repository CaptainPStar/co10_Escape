...
drn_arr_Escape_StartPositionGuardTypes = ["CAF_AG_AFR_P_AK74", "CAF_AG_AFR_P_GL", "CAF_AG_AFR_P_AK47", "CAF_AG_AFR_P_RPK74"];
...
drn_arr_Escape_InfantryTypes_Ind = ["CAF_AG_AFR_P_AK47","CAF_AG_AFR_P_AK74","CAF_AG_AFR_P_RPK74","CAF_AG_AFR_P_PKM","CAF_AG_AFR_P_RPG","CAF_AG_AFR_P_GL"];
