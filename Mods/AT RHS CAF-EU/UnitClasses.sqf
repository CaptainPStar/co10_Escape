...
drn_arr_Escape_StartPositionGuardTypes = ["CAF_AG_EEUR_R_AK74", "CAF_AG_EEUR_R_GL", "at_CAF_AG_EEUR_R_AKS74", "at_CAF_AG_EEUR_R_AK74_dirty"];
...
drn_var_Escape_InnerFenceGuardSecondaryWeapon set [count(drn_var_Escape_InnerFenceGuardSecondaryWeapon),["RH_usp","RH_12Rnd_45cal_usp"]];
...
switch (_enemyFrequency) do {
    case 1: {
        ...
        drn_arr_Escape_MilitaryTraffic_EnemyVehicleClasses_IND = ["CAF_AG_eeur_r_Offroad", "CAF_AG_eeur_r_Offroad_armed_01", "CAF_AG_eeur_r_Offroad_armed_01", "CAF_AG_eeur_r_van_01"];
    };
    case 2: {
...
drn_arr_Escape_InfantryTypes_Ind =  ["at_CAF_AG_EEUR_R_AKS74_PSO1","at_CAF_AG_EEUR_R_Medic","at_CAF_AG_EEUR_R_Engineer","CAF_AG_EEUR_R_AK47","CAF_AG_EEUR_R_AK74","CAF_AG_EEUR_R_RPK74","CAF_AG_EEUR_R_PKM","CAF_AG_EEUR_R_RPG","CAF_AG_EEUR_R_GL","at_CAF_AG_EEUR_R_AKS74","at_CAF_AG_EEUR_R_AK74_dirty","at_CAF_AG_EEUR_R_AKS74U","at_CAF_AG_EEUR_R_AKM","at_CAF_AG_EEUR_R_saiga","at_CAF_AG_EEUR_R_FAL","at_CAF_AG_EEUR_R_G3","at_CAF_AG_EEUR_R_G3SG1","at_CAF_AG_EEUR_R_CZ550"];
...
drn_arr_Escape_RoadBlock_MannedVehicleTypes_Ind = ["CAF_AG_eeur_r_Offroad", "CAF_AG_eeur_r_Offroad_armed_01", "CAF_AG_eeur_r_Offroad_armed_01", "I_HMG_01_hight_f", "I_static_AT_F"];

// Random array. Vehicle classes (preferrably trucks) transporting enemy reinforcements.
drn_arr_Escape_ReinforcementTruck_vehicleClasses = ["rhs_gaz66o_msv","rhs_ural_MSV_01", "rhs_ural_open_MSV_01","rhs_gaz66_msv"];
drn_arr_Escape_ReinforcementTruck_vehicleClasses_Ind = ["CAF_AG_eeur_r_van_01"];
...
drn_arr_Escape_ReinforcementTruck_vehicleClassesMaxCargo = [14, 14, 13];
...
drn_arr_AmmoDepotBasicWeapons set [count drn_arr_AmmoDepotBasicWeapons, ["RH_mak", 50, 2, 5, ["RH_8Rnd_9x18_Mak"], 6]];
drn_arr_AmmoDepotBasicWeapons set [count drn_arr_AmmoDepotBasicWeapons, ["RH_vz61", 50, 2, 5, ["RH_20Rnd_32cal_vz61"], 6]];
drn_arr_AmmoDepotBasicWeapons set [count drn_arr_AmmoDepotBasicWeapons, ["rhs_weap_m14ebrri_leu", 10, 1, 2, ["rhsusf_20Rnd_762x51_m118_special_Mag","rhsusf_20Rnd_762x51_m993_Mag"], 6]];
drn_arr_AmmoDepotBasicWeapons set [count drn_arr_AmmoDepotBasicWeapons, ["rhs_weap_m4", 10, 1, 2, ["rhs_mag_30Rnd_556x45_M855A1_Stanag", "rhs_mag_30Rnd_556x45_M855A1_Stanag_Tracer_Red"], 6]];
drn_arr_AmmoDepotBasicWeapons set [count drn_arr_AmmoDepotBasicWeapons, ["rhs_m4a1_m320", 10, 1, 2, ["rhs_mag_30Rnd_556x45_M855A1_Stanag", "rhs_mag_30Rnd_556x45_M855A1_Stanag_Tracer_Red", "rhs_mag_M433_HEDP", "rhs_mag_M714_white", "rhs_mag_M716_yellow", "rhs_mag_M713_red", "rhs_mag_M585_white", "rhs_mag_M661_green"], 6]];
drn_arr_AmmoDepotBasicWeapons set [count drn_arr_AmmoDepotBasicWeapons, ["rhs_weap_m4_grip", 10, 1, 2, ["rhs_mag_30Rnd_556x45_M855A1_Stanag", "rhs_mag_30Rnd_556x45_M855A1_Stanag_Tracer_Red", "30Rnd_65x39_caseless_mag", "30Rnd_65x39_caseless_mag_Tracer"], 6]];
drn_arr_AmmoDepotBasicWeapons set [count drn_arr_AmmoDepotBasicWeapons, ["rhs_weap_m4a1", 10, 1, 2, ["rhs_mag_30Rnd_556x45_M855A1_Stanag", "rhs_mag_30Rnd_556x45_M855A1_Stanag_Tracer_Red"], 6]];
drn_arr_AmmoDepotBasicWeapons set [count drn_arr_AmmoDepotBasicWeapons, ["hlc_rifle_SAMR", 10, 1, 2, ["hlc_30rnd_556x45_SOST", "hlc_30rnd_556x45_EPR"], 6]];
drn_arr_AmmoDepotBasicWeapons set [count drn_arr_AmmoDepotBasicWeapons, ["rhs_weap_m16a4", 10, 1, 2, ["rhs_mag_30Rnd_556x45_M855A1_Stanag", "rhs_mag_30Rnd_556x45_M855A1_Stanag_Tracer_Red", "rhs_mag_30Rnd_556x45_M855A1_Stanag_Tracer_Green", "rhs_mag_30Rnd_556x45_M855A1_Stanag_Tracer_Yellow"], 6]];
drn_arr_AmmoDepotBasicWeapons set [count drn_arr_AmmoDepotBasicWeapons, ["g36a", 10, 1, 2, ["G36_mag"], 6]];
...
drn_arr_AmmoDepotSpecialWeapons set [count drn_arr_AmmoDepotSpecialWeapons, ["srifle_GM6_F", 10, 1, 2, ["5Rnd_127x108_Mag"], 9]];
drn_arr_AmmoDepotSpecialWeapons set [count drn_arr_AmmoDepotSpecialWeapons, ["rhs_weap_pkp", 50, 1, 4, ["rhs_100Rnd_762x54mmR", "rhs_100Rnd_762x54mmR_green"], 6]];
// non-CAST weapons
drn_arr_AmmoDepotSpecialWeapons set [count drn_arr_AmmoDepotSpecialWeapons, ["Trixie_CZ550", 20, 1, 2, ["Trixie_CZ550_Mag"], 9]];
drn_arr_AmmoDepotSpecialWeapons set [count drn_arr_AmmoDepotSpecialWeapons, ["rhs_weap_m249_pip", 10, 1, 2, ["rhsusf_100Rnd_556x45_soft_pouch"], 6]];


// Weapons and ammo in the launchers box
drn_arr_AmmoDepotLaunchers = [];
// CSAT weapons
drn_arr_AmmoDepotLaunchers set [count drn_arr_AmmoDepotLaunchers, ["rhs_weap_rpg7", 50, 1, 2, ["rhs_rpg7_PG7VL_mag", "rhs_rpg7_PG7VR_mag", "rhs_rpg7_OG7V_mag", "rhs_rpg7_TBG7V_mag"], 6]];
drn_arr_AmmoDepotLaunchers set [count drn_arr_AmmoDepotLaunchers, ["rhs_weap_rpg26", 50, 1, 3, ["rhs_rpg26_mag"], 3]];
drn_arr_AmmoDepotLaunchers set [count drn_arr_AmmoDepotLaunchers, ["rhs_weap_rshg2", 50, 1, 3, ["rhs_rshg2_mag"], 3]];
drn_arr_AmmoDepotLaunchers set [count drn_arr_AmmoDepotLaunchers, ["rhs_weap_igla", 50, 1, 2, ["rhs_mag_9k38_rocket"], 3]];
// non-CSAT weapons
drn_arr_AmmoDepotLaunchers set [count drn_arr_AmmoDepotLaunchers, ["launch_NLAW_F", 10, 1, 2, ["NLAW_F"], 2]];
...
// General weapons
drn_arr_AmmoDepotOrdnance set [count drn_arr_AmmoDepotOrdnance, [objNull, 30, 1, 1, ["DemoCharge_Remote_Mag", "SatchelCharge_Remote_Mag", "ClaymoreDirectionalMine_Remote_Mag", "APERSMine_Range_Mag", "APERSBoundingMine_Range_Mag", "ATMine_Range_Mag", "APERSTripMine_Wire_Mag", "SLAMDirectionalMine_Wire_Mag", "Laserbatteries"], 5]];
...
drn_arr_AmmoDepotVehicleItems = [];
drn_arr_AmmoDepotVehicleItems set [count drn_arr_AmmoDepotVehicleItems, ["ToolKit", 20, 1, 1, [], 0]];
drn_arr_AmmoDepotVehicleItems set [count drn_arr_AmmoDepotVehicleItems, ["Medikit", 20, 1, 1, [], 0]];
drn_arr_AmmoDepotVehicleItems set [count drn_arr_AmmoDepotVehicleItems, ["FirstAidKit", 100, 10, 50, [], 0]];
...
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["Laserdesignator", 10, 1, 2]];
if(!a3e_var_noNV) then {
	drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["NVGoggles", 10, 1, 3]];
};
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["Rangefinder", 10, 1, 2]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["Binocular", 50, 2, 3, [], 0]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["ItemCompass", 50, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["ItemGPS", 10, 1, 2]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["ItemMap", 50, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["ItemRadio", 50, 1, 10]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["ItemWatch", 50, 1, 10]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["acc_flashlight", 50, 1, 5]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["acc_pointer_IR", 10, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["hlc_muzzle_snds_fal", 10, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["hlc_muzzle_snds_g3", 10, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["RH_pmsd", 10, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["RH_pmir", 10, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["RH_tecsd", 10, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["optic_Aco", 10, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["rhs_acc_pgo7v", 10, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["rhs_acc_pkas", 20, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["rhs_acc_ekp1", 20, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["rhs_acc_ekp1b", 20, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["rhs_acc_ekp1c", 20, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["rhs_acc_ekp1d", 20, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["rhs_acc_pso1m2", 20, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["rhs_acc_1p29", 20, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["rhsusf_acc_EOTECH", 1, 10, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["hlc_optic_suit", 10, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["HLC_Optic_ZFSG1", 10, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["hlc_optic_accupoint_g3", 10, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["rhsusf_acc_HAMR", 10, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["rhsusf_acc_LEUPOLDMK4", 10, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["rhsusf_acc_ELCAN", 10, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["rhsusf_acc_ACOG", 10, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["rhsusf_acc_ACOG2", 10, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["SMA_Silencer_556", 10, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["SMA_AIMPOINT", 10, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["iansky_deltapoint", 10, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["iansky_t1", 10, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["iansky_rx01", 10, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["iansky_rds", 10, 1, 3]];
if(!a3e_var_noNV) then {
	drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["rhs_acc_1pn93_1", 10, 1, 3]];
	drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["hlc_optic_PVS4FAL", 10, 1, 3]];
	drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["optic_Nightstalker", 10, 1, 3]];
};
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["O_UavTerminal", 10, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["optic_DMS", 10, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["optic_Yorris", 10, 1, 3]];
drn_arr_AmmoDepotItems set [count drn_arr_AmmoDepotItems, ["optic_LRPS", 10, 1, 3]];
...
drn_arr_CivilianCarWeapons set [count drn_arr_CivilianCarWeapons, ["rhs_weap_rshg2","rhs_rshg2_mag", 1]];
