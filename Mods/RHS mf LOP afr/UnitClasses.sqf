...
switch (_enemyFrequency) do {
    case 1: {
        ...
        a3e_arr_Escape_MilitaryTraffic_EnemyVehicleClasses_IND = ["LOP_AFR_Landrover","LOP_AFR_Landrover_M2","LOP_AFR_Technical_M2","LOP_AFR_Technical","LOP_AFRCiv_Technical_M2","LOP_AFRCiv_Technical","LOP_AFR_M113","LOP_AFR_BTR60","LOP_AFR_BTR70","LOP_AFR_BMP1","LOP_AFR_BMP2","LOP_AFR_T72BA"];
    };
    case 2: {
...
a3e_arr_Escape_InfantryTypes_Ind = ["LOP_AFR_Soldier_TL","LOP_AFR_Soldier_SL","LOP_AFR_Soldier_Medic","LOP_AFR_Soldier_AR","LOP_AFR_Soldier_AT","LOP_AFR_Soldier_Marksman","LOP_AFR_Soldier_IED","LOP_AFR_Soldier","LOP_AFR_Driver","LOP_AFR_Soldier_GL","LOP_AFRCiv_Soldier_TL","LOP_AFRCiv_Soldier_SL","LOP_AFRCiv_Soldier_Medic","LOP_AFRCiv_Soldier_AR","LOP_AFRCiv_Soldier_AT","LOP_AFRCiv_Soldier_Marksman","LOP_AFRCiv_Soldier_IED","LOP_AFRCiv_Soldier","LOP_AFRCiv_Driver","LOP_AFRCiv_Soldier_GL",];
...
a3e_arr_Escape_RoadBlock_MannedVehicleTypes_Ind = ["LOP_AFR_Landrover","LOP_AFR_Landrover_M2","LOP_AFR_Technical_M2","LOP_AFR_Technical","LOP_AFRCiv_Technical_M2","LOP_AFRCiv_Technical","LOP_AFR_M113", "LOP_AFR_NSV_TriPod", "LOP_AFR_Static_M2", "LOP_AFR_Static_M2_MiniTripod", "LOP_AFR_Static_Mk19_TriPod"];
...
a3e_arr_ComCenParkedVehicles = ["rhs_uaz_MSV_01","rhs_uaz_open_MSV_01","rhs_gaz66_msv","rhs_gaz66o_msv","rhs_gaz66_r142_msv","rhs_gaz66_ap2_msv","rhs_gaz66_repair_msv","rhs_ural_MSV_01","rhs_ural_fuel_MSV_01","rhs_ural_open_MSV_01","rhs_tigr_ffv_3camo_msv","rhs_tigr_ffv_msv", "LOP_AFR_Landrover","LOP_AFR_Landrover_M2","LOP_AFR_Technical_M2","LOP_AFR_Technical","LOP_AFRCiv_Technical_M2","LOP_AFRCiv_Technical","LOP_AFR_M113"];
