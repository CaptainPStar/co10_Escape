...
a3e_arr_Escape_MilitaryTraffic_CivilianVehicleClasses = ["LOP_AFR_Civ_Hatchback", "LOP_AFR_Civ_UAZ", "LOP_AFR_Civ_UAZ_Open", "LOP_AFR_Civ_Offroad", "C_Quadbike_01_F", "LOP_AFR_Civ_Landrover", "LOP_AFR_Civ_Hatchback", "C_Hatchback_01_sport_F", "LOP_AFR_Civ_Offroad", "C_Quadbike_01_F", "LOP_AFR_Civ_Landrover", "LOP_AFR_Civ_Ural_open", "LOP_AFR_Civ_Ural", "C_Van_01_fuel_F"];
...
switch (_enemyFrequency) do {
    case 1: {
        ...
        a3e_arr_Escape_MilitaryTraffic_EnemyVehicleClasses_IND = ["LOP_AFR_Landrover","LOP_AFR_Landrover_M2","LOP_AFR_Offroad_M2","LOP_AFR_Offroad","LOP_AFR_M113_W","LOP_AFR_BTR60","LOP_AFR_T72BA"];
    };
    case 2: {
...
a3e_arr_Escape_RoadBlock_MannedVehicleTypes_Ind = ["LOP_AFR_Landrover","LOP_AFR_Landrover_M2","LOP_AFR_Offroad_M2","LOP_AFR_Offroad","LOP_AFR_M113_W", "LOP_AFR_Static_M2", "LOP_AFR_Static_M2_MiniTripod", "LOP_AFR_Static_Mk19_TriPod"];
...
a3e_arr_Escape_ReinforcementTruck_vehicleClasses_Ind = ["rhs_ural_open_MSV_01"];
...
a3e_arr_ComCenStaticWeapons = ["LOP_AFR_Static_M2"];
// A communication center have two parked and empty vehicles of the following possible types.
a3e_arr_ComCenParkedVehicles = ["rhs_uaz_MSV_01","rhs_uaz_open_MSV_01","rhs_gaz66_msv","rhs_gaz66o_msv","rhs_gaz66_r142_msv","rhs_gaz66_ap2_msv","rhs_gaz66_repair_msv","rhs_ural_MSV_01","rhs_ural_fuel_MSV_01","rhs_ural_open_MSV_01","rhs_tigr_ffv_3camo_msv","rhs_tigr_ffv_msv", "LOP_AFR_Landrover","LOP_AFR_Landrover_M2","LOP_AFR_Offroad_M2","LOP_AFR_Offroad","LOP_AFR_M113_W"];

// Random array. Enemies sometimes use civilian vehicles in their unconventional search for players. The following car types may be used.
a3e_arr_Escape_EnemyCivilianCarTypes = ["LOP_AFR_Civ_Hatchback", "LOP_AFR_Civ_UAZ", "LOP_AFR_Civ_UAZ_Open", "LOP_AFR_Civ_Offroad", "C_Quadbike_01_F", "LOP_AFR_Civ_Landrover", "LOP_AFR_Civ_Hatchback", "C_Hatchback_01_sport_F", "LOP_AFR_Civ_Offroad", "C_Quadbike_01_F", "LOP_AFR_Civ_Landrover", "LOP_AFR_Civ_Ural_open", "LOP_AFR_Civ_Ural", "C_Van_01_fuel_F"];

// Vehicles, weapons and ammo at ammo depots

// Random array. An ammo depot contains one static weapon of the followin types:
a3e_arr_Escape_AmmoDepot_StaticWeaponClasses = ["RHS_NSV_TriPod_VDV", "LOP_AFR_Static_Mk19_TriPod", "RHS_NSV_TriPod_VDV", "O_static_AT_F", "O_static_AA_F"];
...
a3e_arr_AmmoDepotBasicWeapons set [count a3e_arr_AmmoDepotBasicWeapons, ["rhs_weap_ak74m_camo", 100, 3, 5, ["rhs_30Rnd_545x39_AK", "rhs_30Rnd_545x39_AK_green"], 6]];
a3e_arr_AmmoDepotBasicWeapons set [count a3e_arr_AmmoDepotBasicWeapons, ["rhs_weap_ak74m_2mag_camo", 50, 2, 4, ["rhs_30Rnd_545x39_AK", "rhs_30Rnd_545x39_AK_green"], 4]];
...
a3e_arr_CrashSiteWeapons set [count a3e_arr_CrashSiteWeapons, ["rhs_weap_XM2010_sa", 10, 1, 2, ["rhsusf_5Rnd_300winmag_xm2010"], 8]];
