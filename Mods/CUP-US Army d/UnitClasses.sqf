...
a3e_arr_Escape_ReinforcementTruck_vehicleClassesMaxCargo = [4, 8, 10, 11];
...
a3e_arr_Escape_MotorizedSearchGroup_vehicleClassesMaxCargo = [3, 3, 3, 3, 3, 3, 4, 11, 8, 8, 8, 6, 9];
