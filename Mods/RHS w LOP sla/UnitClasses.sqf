...
drn_arr_Escape_StartPositionGuardTypes = ["LOP_SLA_Soldier", "LOP_SLA_Soldier_GL", "LOP_SLA_Soldier_AR", "LOP_SLA_Soldier"];
...
switch (_enemyFrequency) do {
    case 1: {
        ...
        drn_arr_Escape_MilitaryTraffic_EnemyVehicleClasses_IND = ["LOP_SLA_UAZ", "LOP_SLA_Ural_open", "LOP_SLA_Ural_fuel", "LOP_SLA_Ural", "LOP_SLA_BM21", "LOP_SLA_BTR60", "LOP_SLA_BTR70", "LOP_SLA_BMP1", "LOP_SLA_BMP1D", "LOP_SLA_BMP1K", "LOP_SLA_BMP1P", "LOP_SLA_BMP2", "LOP_SLA_ZSU234", "LOP_SLA_T72BA", "LOP_SLA_T72BB"];
    };
    case 2: {
...
drn_arr_Escape_InfantryTypes_Ind = ["LOP_SLA_Soldier_TL","LOP_SLA_Soldier_SL","LOP_SLA_Soldier_Medic","LOP_SLA_Soldier_AR","LOP_SLA_Soldier_A_AR","LOP_SLA_Soldier_AT","LOP_SLA_Soldier_A_AT","LOP_SLA_Soldier_Marksman","LOP_SLA_Soldier_Engineer","LOP_SLA_Soldier","LOP_SLA_Soldier_GL","LOP_SLA_Officer"];
...
drn_arr_Escape_RoadBlock_MannedVehicleTypes = ["rhs_btr60_msv", "RHS_NSV_TriPod_VDV", "O_static_AT_F", "LOP_SLA_NSV_TriPod"];
drn_arr_Escape_RoadBlock_MannedVehicleTypes_Ind = ["LOP_SLA_UAZ", "LOP_SLA_UAZ", "LOP_SLA_BTR60", "LOP_SLA_NSV_TriPod", "I_static_AT_F"];
...
drn_arr_Escape_ReinforcementTruck_vehicleClasses_Ind = ["LOP_SLA_Ural_open","LOP_SLA_Ural"];
