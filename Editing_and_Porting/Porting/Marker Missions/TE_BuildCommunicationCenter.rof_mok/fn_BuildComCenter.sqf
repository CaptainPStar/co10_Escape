...
_parkedVehicleClasses = ["B_Truck_01_fuel_F","B_Truck_01_transport_F"];
_staticWeaponClasses = ["B_HMG_01_high_F"];
...
_object setflagtexture "\a3\ui_f\data\Logos\arma3_expansion_ca.paa";
