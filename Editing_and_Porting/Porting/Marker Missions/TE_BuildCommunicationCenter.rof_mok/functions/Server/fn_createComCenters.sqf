...
for [{_i=0},{_i<_totalMarkerCount},{_i=_i+1}] do {
	...
	if(_ok) then {
		call compile format["[%1, %2 ,a3e_arr_ComCenStaticWeapons,a3e_arr_ComCenParkedVehicles] call %3;",str _pos, _dir,selectRandom["a3e_fnc_BuildComCenter","a3e_fnc_BuildComCenter2","a3e_fnc_BuildComCenter3","a3e_fnc_BuildComCenter4","a3e_fnc_BuildComCenter5"]];
